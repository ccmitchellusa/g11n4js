define(["dojo/_base/lang", "./gregorian", "./persian/Date"], function(lang, gregorian, IDate){
...
// Utility methods to do arithmetic calculations with persian.Dates
	...
	persian.getDaysInMonth = function(/*dojox/date/persian/Date*/month){
...
//TODO: define persian.isLeapYear?  Or should it be invalid, since it has different meaning?
	...
	persian.compare = function(/*dojox/date/persian/Date*/date1, /*dojox/date/persian/Date*/date2, /*String?*/portion){
		// summary:
	...
	persian.add = function(/*dojox/date/persian/Date*/date, /*String*/interval, /*int*/amount){
		// summary:
	...
	persian.difference = function(/*dojox/date/persian/Date*/date1, /*dojox/date/persian/Date?*/date2, /*String?*/interval){
		// summary:
		//		date2 - date1
		// date1: dojox/date/persian/Date
		// date2: dojox/date/persian/Date
		...
		switch(interval){
		case "weekday":
			var days = Math.round(persian.difference(date1, date2, "day"));
			var weeks = parseInt(persian.difference(date1, date2, "week"));
			var mod = days % 7;
		...
		case "week":
			...
			delta = parseInt(persian.difference(date1, date2, "day") / 7);
			break;
		case "day":
			delta /= 24;
			// fallthrough
