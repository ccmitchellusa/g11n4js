define(["dojo/_base/lang", "./gregorian", "./islamic/Date"], function(lang, gregorian, IDate){
	...
	islamic.getDaysInMonth = function(/*dojox/date/islamic/Date*/month){
...
//TODO: define islamic.isLeapYear?  Or should it be invalid, since it has different meaning?
	...
	islamic.compare = function(/*dojox/date/islamic/Date*/date1, /*dojox/date/islamic/Date*/date2, /*String?*/portion){
		// summary:
	...
	islamic.add = function(/*dojox/date/islamic/Date*/date, /*String*/interval, /*int*/amount){
		// summary:
	...
	islamic.difference = function(/*dojox/date/islamic/Date*/date1, /*dojox/date/islamic/Date?*/date2, /*String?*/interval){
		// summary:
		//		date2 - date1
		// date1: dojox/date/islamic/Date
		// date2: dojox/date/islamic/Date
		...
		switch(interval){
		case "weekday":
			var days = Math.round(islamic.difference(date1, date2, "day"));
			var weeks = parseInt(islamic.difference(date1, date2, "week"));
			var mod = days % 7;
		...
		case "week":
			...
			delta = parseInt(islamic.difference(date1, date2, "day") / 7);
			break;
		case "day":
			delta /= 24;
			// fallthrough
