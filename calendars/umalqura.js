define(["dojo/_base/lang", "./gregorian", "./umalqura/Date"], function(lang, gregorian, IDate){
...
// Utility methods to do arithmetic calculations with umalqura.Dates
	...
	umalqura.getDaysInMonth = function(/*dojox/date/umalqura/Date*/month){
...
//TODO: define umalqura.isLeapYear?  Or should it be invalid, since it has different meaning?
	...
	umalqura.compare = function(/*dojox/date/umalqura/Date*/date1, /*dojox/date/umalqura/Date*/date2, /*String?*/portion){
		// summary:
	...
	umalqura.add = function(/*dojox/date/umalqura/Date*/date, /*String*/interval, /*int*/amount){
		// summary:
	...
	umalqura.difference = function(/*dojox/date/umalqura/Date*/date1, /*dojox/date/umalqura/Date?*/date2, /*String?*/interval){
		// summary:
		//		date2 - date1
		// date1: dojox/date/umalqura/Date
		// date2: dojox/date/umalqura/Date
		...
		switch(interval){
		case "weekday":
			var days = Math.round(umalqura.difference(date1, date2, "day"));
			var weeks = parseInt(umalqura.difference(date1, date2, "week"));
			var mod = days % 7;
		...
		case "week":
			...
			delta = parseInt(umalqura.difference(date1, date2, "day") / 7);
			break;
		case "day":
			delta /= 24;
			// fallthrough
