define(["dojo/_base/lang", "./gregorian", "./buddhist/Date"], function(lang, gregorian, BDate){
...
// Utility methods to do arithmetic calculations with buddhist.Dates
	...
	buddhist.getDaysInMonth = function(/*dojox/date/buddhist/Date*/dateObject){
		return gregorian.getDaysInMonth(dateObject.toGregorian());
	};

	buddhist.isLeapYear = function(/*dojox/date/buddhist/Date*/dateObject){
		return gregorian.isLeapYear(dateObject.toGregorian());
	};

//FIXME: reduce compare, add, diff also
	buddhist.compare = function(/*dojox/date/buddhist/Date*/date1, /*dojox/date/buddhist/Date*/date2, /*String?*/portion){
		// summary:
		//		Compare two buddhist date objects by date, time, or both.
		return gregorian.compare(date1, date2, portion); // int
	};


	buddhist.add = function(/*dojox/date/buddhist/Date*/date, /*String*/interval, /*int*/amount){
		// summary:
	...
	buddhist.difference = function(/*dojox/date/buddhist/Date*/date1, /*dojox/date/buddhist/Date?*/date2, /*String?*/interval){
		// summary:
		//		date2 - date1
		// date1: dojox/date/buddhist/Date
		// date2: dojox/date/buddhist/Date
		//		If not specified, the current dojox.date.buddhist.Date is used.
		// interval:
		//		A string representing the interval.  One of the following:
		//		"year", "month", "day", "hour", "minute", "second",
		//		"millisecond",  "week", "weekday"
		...
		switch(interval){
		case "weekday":
			var days = Math.round(buddhist.difference(date1, date2, "day"));
			var weeks = parseInt(buddhist.difference(date1, date2, "week"));
			var mod = days % 7;
		...
		case "week":
			...
			delta = parseInt(buddhist.difference(date1, date2, "day") / 7);
			break;
		case "day":
			delta /= 24;
			// fallthrough
