define(["dojo/_base/lang", "dojo/_base/array", "../gregorian", "dojo/i18n",
	"dojo/regexp", "dojo/string", "./Date", "dojo/i18n!dojo/cldr/nls/persian"],
       function(lang, arr, gregorian, i18n, regexp, string, IDate, bundle){
		...
		return pattern.replace(/([a-z])\1*/ig, function(match){
			...
			switch(c){
				...
				case 'z':
					...
					s = gregorian.getTimezoneName(dateObject.toGregorian());
					if(s){ break; }
					l = 4;
