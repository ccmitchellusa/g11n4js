define(["dojo/_base/lang", "./gregorian", "./hebrew/Date"], function(lang, gregorian, HDate){
...
// added for compat to date
	hebrew.getDaysInMonth = function(/*dojox/date/hebrew/Date*/month){
...
//TODO: define hebrew.isLeapYear?  Or should it be invalid, since it has different meaning?
	...
	hebrew.compare = function(/*dojox/date/hebrew/Date*/dateheb1, /*dojox/date/hebrew/Date*/dateheb2, /*String?*/portion){
		// summary:
		...
		return gregorian.compare.apply(null, arguments);
	};


	hebrew.add = function(/*dojox/date/hebrew/Date*/date, /*String*/interval, /*int*/amount){
		// summary:
	...
	hebrew.difference = function(/*dojox/date/hebrew/Date*/date1, /*dojox/date/hebrew/Date?*/date2, /*String?*/interval){
		// summary:
		//		date2 - date1
		// date1: dojox/date/hebrew/Date
		// date2: dojox/date/hebrew/Date
		...
		switch(interval){
		case "weekday":
			var days = Math.round(hebrew.difference(date1, date2, "day"));
			var weeks = parseInt(hebrew.difference(date1, date2, "week"));
			var mod = days % 7;
		...
		case "week":
			...
			delta = parseInt(hebrew.difference(date1, date2, "day") / 7);
			break;
		case "day":
			delta /= 24;
			// fallthrough
